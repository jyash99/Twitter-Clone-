                            ...
                            <div class="feed_item">
                               <div class="joke">
                                  <div class="joke_wrapper">
                                     ...
                                     <c:if test = "${not member.is_verified}">
                                        <button type="submit" class="follow-member" style="margin-top: 10px; border: none;" member-id="${member.id}">
                                            <span tabindex="-1">Follow</span>
                                        </button>
                                     </c:if>
                                     <c:if test = "${member.is_verified}">
                                        <button type="submit" class="follow-member followed-button" style="margin-top: 10px; border-color: white" member-id="${member.id}">
