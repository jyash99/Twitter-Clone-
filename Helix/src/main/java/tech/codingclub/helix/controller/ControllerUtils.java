            ...
            if (cookies != null) {
                for (Cookie cookie : cookies) {
                    if (cookie.getName().equals(TOKEN_COOKIE)) {
                        ...
                        if (member != null && member.getToken() != null) { //.&& author.token_expire_time != null && author.token_expire_time > new Date().getTime()) {
